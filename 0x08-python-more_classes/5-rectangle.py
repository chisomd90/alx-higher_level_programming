#!/usr/bin/python3
"""
This python module efines a class Rectangle
"""


class Rectangle:
    """this is a class epresentation of a rectangle"""
    ...
    def __del__(self):
        """the del prints a string when an instance has been deleted"""
        print("Bye rectangle...")
    ...
    def __str__(self):
        """str returns a printable string representation of the rectangle"""
        string = ""
    ...
    def __repr__(self):
        """repr returns a string representation of the rectangle for reproduction"""
